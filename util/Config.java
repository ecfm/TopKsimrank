package fanweizhu.fastSim.util;
...
public final class Config {
    ...
    public static double stopRea					=0.001; // smallest reachability to stop at
	public static int maxNode						=1000;	// maximum number of nodes to be stored in the graph
